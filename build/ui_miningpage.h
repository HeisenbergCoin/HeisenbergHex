...
public:
    ...
    {
        MiningPage->setWindowTitle(QApplication::translate("MiningPage", "Cooking", 0, QApplication::UnicodeUTF8));
        ...
        startButton->setText(QApplication::translate("MiningPage", "Start Cooking", 0, QApplication::UnicodeUTF8));
        ...
        typeBox->insertItems(0, QStringList()
         << QApplication::translate("MiningPage", "Solo Cooking", 0, QApplication::UnicodeUTF8)
         << QApplication::translate("MiningPage", "Pool Cooking", 0, QApplication::UnicodeUTF8)
        );
